...
class TinyHumanMemoryClient:
    ...
    def _query_openai(
        ...
        *,
        ...
        self._raise_llm_error(r, "OpenAI")
        data = r.json()
    ...
    def _query_anthropic(
        ...
        *,
        ...
        self._raise_llm_error(r, "Anthropic")
        data = r.json()
    ...
    def _query_google(
        ...
        *,
        ...
        self._raise_llm_error(r, "Google")
        data = r.json()
    ...
    def _query_custom(
        ...
        *,
        ...
        with httpx.Client(timeout=60) as http:
            ...
            self._raise_llm_error(r, "Custom provider")
            data = r.json()
            # OpenAI-compatible response format
            return data["choices"][0]["message"]["content"]

    def _raise_llm_error(self, response: httpx.Response, provider: str) -> None:
